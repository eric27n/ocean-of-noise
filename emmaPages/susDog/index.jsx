        ...
        <div className="main-content">
          <div className="overlap">
            <div className="track-list">
              ...
              <img className="img" alt="Divider" src="divider-3.svg" />
              ...
              <img className="divider-2" alt="Divider" src="divider-4.svg" />
              ...
              <img className="divider-3" alt="Divider" src="divider-5.svg" />
              <img className="divider-4" alt="Divider" src="divider-6.svg" />
              ...
              <img className="divider-5" alt="Divider" src="divider-7.svg" />
              ...
              <img className="divider-6" alt="Divider" src="divider-8.svg" />
              <img className="divider-7" alt="Divider" src="divider-9.svg" />
              ...
              <img className="divider-8" alt="Divider" src="divider-10.svg" />
              ...
              <img className="divider-9" alt="Divider" src="divider-11.svg" />
              <img className="divider-10" alt="Divider" src="divider-12.svg" />
              ...
              <img className="divider-11" alt="Divider" src="divider-13.svg" />
            </div>
            <div className="blog-card">
              <div className="overlap-group-wrapper">
                <div className="overlap-group">
                  ...
                  <div className="title">About Album Name</div>
                </div>
              </div>
            </div>
            <div className="album-credits-wrapper">
              <div className="album-credits">
                <div className="overlap-2">
                  ...
                  <img className="divider-12" alt="Divider" src="image.svg" />
                  <img className="divider-13" alt="Divider" src="divider.svg" />
                </div>
              </div>
            </div>
        ...
        <div className="album">
          <div className="overlap-3">
            <div className="recommendation">
              <div className="media" />
              <div className="title-3">Album Name</div>
            </div>
            ...
            <div className="blog-card-feature">
              <div className="overlap-group-2">
                <div className="overlap-4">
                  <div className="text-wrapper-7">Album Name</div>
                  <div className="text-wrapper-8">Artist Name</div>
                </div>
                <img className="media-2" alt="Media" src="media.png" />
                <div className="media-label">Album</div>
